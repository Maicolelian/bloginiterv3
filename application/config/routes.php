...
//$route['store/(:any)/(:any)/(:any)'] = 'store/index/$1/$2/$3';

$route['assets/js/comment.js'] = 'blog/comment';
$route['spa/favorite/(:num)'] = 'spa/favorite/$1';
$route['spa/category/(:any)'] = 'spa/category/$1';
$route['spa/jcategory_list/(:any)'] = 'spa/jcategory_list/$1';
$route['spa/jpost_list/(:any)'] = 'spa/jpost_list/$1';
